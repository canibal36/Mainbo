...
<head>
    ...
    <!-- All min css -->
    <link rel="stylesheet" href="assets-landing/css/all.min.css">
    <!-- Swiper bundle min css -->
    <link rel="stylesheet" href="assets-landing/css/swiper-bundle.min.css">
    <!-- Magnigic popup css -->
...
<body>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">
                        <div class="footer__item newsletter">
                            ...
                            <div class="social-icon mt-40">
                                ...
                                <a href="#0"><i class="fab fa-tiktok"></i></a>  
    ...
    <script src="assets-landing/js/swiper-bundle.min.js"></script>
    <!-- Counterup min Js -->
    ...
    <!-- Nice select min Js -->
    <script src="assets-landing/js/nice-select.min.js"></script>
    <!-- Pace min Js -->
    <script src="assets-landing/js/pace.min.js"></script>
    <!-- Isotope pkgd min Js -->
    <script src="assets-landing/js/isotope.pkgd.min.js"></script>
    <!-- Waypoints Js -->
    <script src="assets-landing/js/jquery.waypoints.js"></script>
    <!-- Script Js -->
